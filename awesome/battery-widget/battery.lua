...
local function worker(user_args)
    ...
    local font = args.font or 'SauceCodePro Nerd Font'
    ...
    local position = args.notification_position or "top_left"
    local timeout = args.timeout or 10

    local warning_msg_title = args.warning_msg_title or 'Will, Battery is dying !!!'
    local warning_msg_text = args.warning_msg_text or 'Go charge your arch !'
    ...
    local function show_battery_warning()
        naughty.notify {
            ...
            timeout = 0, -- show the warning for a longer time
            hover_timeout = 0.5,
    ...
    function(widget, stdout)
        ...
        if (charge >= 1 and charge < 35) then
        ...
        elseif (charge >= 35 and charge < 40) then batteryType = "battery-caution%s-symbolic"
